...
export function Organizations() {
  ...
  const mapped = (organizations || []).map((org: OrganizationModel) => ({
    id: org.id_osc,
  ...
  const filteredOrganizations = mapped.filter((org) => {
    const matchesSearch =
          ...
          <div key={org.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <MapPin className="w-4 h-4" /><span>{org.location}</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <Phone className="w-4 h-4" /><span>{org.contact}</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <Mail className="w-4 h-4" /><span>{org.email}</span>
              </div>
            </div>
